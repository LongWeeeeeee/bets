...
| `_deliver_and_persist_signal(...)` | 27788 | единая точка доставки; half-stake ELO, согласие предматчевой ML и `late_model_against` (любая обычная ставка, если Late ML против target) — до prepare/dedup |
