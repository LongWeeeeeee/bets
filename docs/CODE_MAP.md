...
**Правило допуска в post_lane (all) — с 2026-08-07:** `POST_LANE_MIN_DURATION = 28` (было 20, env `ANALISE_POST_LANE_MIN_DURATION`). Поминутная развёртка на honest holdout дала на 28-й отчётливый пик (64.4/64.5/64.5 на моментах 20'/26'/32' против 64.2/64.0/63.0 у прежнего порога), соседние 27 и 29 ниже. Совпадает с границей `EARLY_LEAD_WINDOW`. Вступает в силу при пересборке словаря.
