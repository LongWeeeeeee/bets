...
- Training выбирает `C` по log loss на old chronological validation из `{0.001, 0.003, 0.01, 0.03, 0.1, 0.3, 1.0}`; текущий artifact использует `C=0.003`, forward в selection не участвует.
